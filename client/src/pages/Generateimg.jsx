  ...
  return (
    <div className="h-full p-6 flex items-start gap-6 text-slate-700">
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full h-10 mt-8 flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white text-sm rounded-md disabled:opacity-60"
        >
          {loading ? (
